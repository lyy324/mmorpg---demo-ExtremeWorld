...
namespace Candlelight.UI
{
...
#endif
	{
		...
		/// <summary>
		/// Sets the clip softness. Required by <see cref="UnityEngine.UI.IClippable"/> since Unity 2019.2.
		/// Softness requires material support; this quad renderer only supports hard clipping via
		/// <see cref="SetClipRect"/>, so this is intentionally a no-op.
		/// </summary>
		/// <param name="clipSoftness">Softness values passed by the parent <see cref="UnityEngine.UI.RectMask2D"/>.</param>
