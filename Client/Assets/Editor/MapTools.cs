...
public class MapTools
{
    ...
    public static void ExportTeleports()
    {
        ...
        List<TeleporterObject> AllTeleportObjects = new List<TeleporterObject>();
        ...
        foreach (var map in DataManager.Instance.Maps)
        {
            ...
            // ★ 核心操作：强行打开该地图场景（Single模式=单独打开，关闭其他场景）
            EditorSceneManager.OpenScene(sceneFile, OpenSceneMode.Single);

            //找到并且遍历所有的 传送点 获取它们的 id 位置 朝向 等信息
            TeleporterObject[] teleportObjects = GameObject.FindObjectsOfType<TeleporterObject>();
