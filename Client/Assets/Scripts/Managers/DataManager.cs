...
public class DataManager : Singleton<DataManager>
{
    ...
    public void SaveTeleporters()
    {
        ...
        // Keep the editor output and the shared server source data in sync.
        string clientPath = Path.Combine(this.DataPath, "TeleporterDefine.txt");
        File.WriteAllText(clientPath, json);

        string sharedPath = Path.GetFullPath(Path.Combine(
            Application.dataPath, "..", "..", "Data", "Data", "TeleporterDefine.txt"));
